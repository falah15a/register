...
<html lang="en">
<head>
    <title>Formulir Pendaftaran Siswa Baru | SMK N 4 PURWOKERTO</title>
...
<body>
    <nav class="navbar navbar-expand-lg bg-success navbar-dark">
      <div class="container">
          <a class="navbar-brand" href="#">Form Pendaftaraan Siswa Baru SMA N 4 Purwokerto</a>
      ...
      data-aos-duration="1300">
        <div class="col-md-6 pe-4 ps-4">
          ...
          method="POST">
            ...
            <input class="btn btn-outline-success" type="submit" value="Daftar" name="daftar" id="liveAlertBtn">
          </form>
        </div>
      </div>
    </div>
